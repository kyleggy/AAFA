package com.hp.fedex.day.aafa.qc.readFromQC.infrastructure;
...
public class RestConnector {
    ...
    public String buildUrl(String path) {
        return String.format("https://%1$s:%2$s/%3$s", host, port, path);
    }
    /**
     * @return the cookies
     */
     ...
     * @throws Exception
     */
    private Response retrieveHtmlResponse(HttpsURLConnection con) throws Exception {
